...
public class Logic {
    ...
    private final String winInfos[] = {" will be kicked...", ", something went wrong...", ", practice, practice!!", " stood up with his left foot", ": It's not his day", "'ll act out soon",
            " saw the plane", " didn't drink coffee", "xD", "xDDDD", " just kidding", " will be kicked hard", " caught lag", ", BUT IT WAS BLOWING", "Seriously?!", " is dominated", ":))"};
